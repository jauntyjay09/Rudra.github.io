...
<body>
    <nav class="navbar navbar-expand-lg"  style="background-color: #47ff73;" >
        <a class="navbar-brand" href="index.html">RUDRA</a>
        ...
        <ul class="nav ">
          <li class="nav-item">
            <a class="nav-link active" href="abt.html">About us</a>
          </li>
